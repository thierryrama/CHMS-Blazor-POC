...
namespace StatCan.Chms.Client.OpenApi.ViewModels.CalendarToastUI;
...
public class CalendarViewModel : BaseViewModel
{
    ...
    private List<TUISchedule> _Schedules = new List<TUISchedule>();

    public List<TUISchedule> Schedules
    {
        get => _Schedules;
        set { SetValue(ref _Schedules, value); }
    }
    ...
    public TUICalendarOptions CalendarOptions
    {
        ...
        set { SetValue(ref _CalendarOptions, value); }
    }
    ...
    {
        get => _CalendarProps;
        set { SetValue(ref _CalendarProps, value); }
    }
    ...
    public TUICalendarViewName CalendarViewName
    {
        ...
        set { SetValue(ref _CalendarViewName, value); }
    }
